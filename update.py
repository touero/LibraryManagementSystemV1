...
class Ui_Dialog5(object):
    def setupUi(self, Dialog):
        ...
        self.retranslateUi(Dialog)
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        self.pushButton_2.clicked.connect(Dialog.updateborrow)
        self.retranslateUi(Dialog)
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        self.pushButton_3.clicked.connect(Dialog.updatebooks)
        self.retranslateUi(Dialog)
        QtCore.QMetaObject.connectSlotsByName(Dialog)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "修改"))
        self.label.setText(_translate("Dialog", "修改"))
        self.pushButton.setText(_translate("Dialog", "修改读者信息表"))
        self.pushButton_2.setText(_translate("Dialog", "修改借阅信息表"))
        self.pushButton_3.setText(_translate("Dialog", "修改图书信息表"))
