...
class Ui_Dialog4(object):
    def setupUi(self, Dialog):
        ...
        self.retranslateUi(Dialog)
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        self.pushButton_2.clicked.connect(Dialog.addborrow)

        self.retranslateUi(Dialog)
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        self.pushButton_3.clicked.connect(Dialog.addbooks)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "添加"))
        self.pushButton.setText(_translate("Dialog", "添加读者信息表"))
        self.pushButton_2.setText(_translate("Dialog", "添加借阅信息表"))
        self.pushButton_3.setText(_translate("Dialog", "添加图书信息表"))
